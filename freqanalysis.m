...
cfg.foi         = 30:1:50;             % Frequencies we want to estimate from 1 Hz to 45 Hz in steps of 1HZ
cfg.toi         = -params.pre:0.05:params.post; % Times to center on
cfg.t_ftimwin   = 5./cfg.foi;         % length of time window
cfg.tapsmofrq   = ones(length(cfg.foi), 1);        % Smoothing.
